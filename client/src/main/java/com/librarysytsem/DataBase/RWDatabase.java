...
public class RWDatabase {
    ...
    private static final String filePath = "src/main/java/com/librarysytsem/DataBase/BooksDB.txt" ;
    //users Data file
    private static final String usersFilePath = "src/main/java/com/librarysytsem/DataBase/UsersDB.csv" ;
    //owned books data file
    private static final String ownedBooksPath = "src/main/java/com/librarysytsem/DataBase/UsersBooksRelationDB.csv" ;
